class CartDrawer extends HTMLElement {
  constructor() {
    ...
    if(this.nodeName == "CART-DRAWER"){
      const cartButtonId = 'CartDrawer-Checkout'
      const hiddenCartButtonId = 'CartDrawer-Checkout-hidden';
  ...
  async onSubmit(event, hiddenCartButtonId) {
    ...
    const async_result = await this.cartItems.checkAndUpdateCartItems(true);
    this.cartItems = document.querySelector('cart-drawer-items');
  ...
  async open(triggeredBy) {
    ...
    await this.cartItems.checkAndUpdateCartItems();
  ...
  renderContents(parsedState) {
    // console.log("renderContents triggeredBy: ");
